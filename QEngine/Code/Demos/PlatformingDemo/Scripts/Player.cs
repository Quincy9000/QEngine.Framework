...
//            Body.Rotation += time * 20;
			...
			if(Input.IsLeftMouseButtonHeld() && Accumulator.CheckAccum("Spawner", 0.03f))
			{
				...
				{
					case 0:
						Instantiate(new Block(10, 10), Camera.ScreenToWorld(Input.MousePosition()));
						break;
					case 1:
						Instantiate(new Ball(5), Camera.ScreenToWorld(Input.MousePosition()));
						break;
				}
			}
