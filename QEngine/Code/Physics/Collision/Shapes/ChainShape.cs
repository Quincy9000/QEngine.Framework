...
namespace QEngine.Physics.Collision.Shapes
{
    ...
    public class ChainShape : Shape
    {
            ...
            : base(0)
        {
            ...
            System.Diagnostics.Debug.Assert(vertices != null && vertices.Count >= 3);
            System.Diagnostics.Debug.Assert(vertices[0] != vertices[vertices.Count - 1]); //Velcro. See http://www.box2d.org/forum/viewtopic.php?f=4&t=7973&p=35363

            for (int i = 1; i < vertices.Count; ++i)
            {
                // If the code crashes here, it means your vertices are too close together.
                System.Diagnostics.Debug.Assert(Vector2.DistanceSquared(vertices[i - 1], vertices[i]) > Settings.LinearSlop * Settings.LinearSlop);
            }
        ...
        {
            System.Diagnostics.Debug.Assert(0 <= index && index < Vertices.Count - 1);
        ...
        {
            System.Diagnostics.Debug.Assert(childIndex < Vertices.Count);
