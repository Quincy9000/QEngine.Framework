...
using QEngine.Physics.Tools.TextureTools;

namespace QEngine.Physics.Utilities
{
    public static class PolygonUtils
    {
        ...
        {
            System.Diagnostics.Debug.Assert(radians > 0, "The arc needs to be larger than 0");
            System.Diagnostics.Debug.Assert(sides > 1, "The arc needs to have more than 1 sides");
            System.Diagnostics.Debug.Assert(radius > 0, "The arc needs to have a radius larger than 0");
