...
using QEngine.Physics.Tools.ConvexHull.GiftWrap;
using QEngine.Physics.Tools.Triangulation.Bayazit;
using QEngine.Physics.Tools.Triangulation.Delaunay;
using QEngine.Physics.Tools.Triangulation.Earclip;
using QEngine.Physics.Tools.Triangulation.FlipCode;
using QEngine.Physics.Tools.Triangulation.Seidel;

namespace QEngine.Physics.Tools.Triangulation.TriangulationBase
{
            ...
            switch (algorithm)
            {
                case TriangulationAlgorithm.Earclip:
                    if (Settings.SkipSanityChecks)
                        System.Diagnostics.Debug.Assert(!vertices.IsCounterClockWise(), "The Earclip algorithm expects the polygon to be clockwise.");
                    else
                    {
                ...
                case TriangulationAlgorithm.Bayazit:
                    if (Settings.SkipSanityChecks)
                        System.Diagnostics.Debug.Assert(vertices.IsCounterClockWise(), "The polygon is not counter clockwise. This is needed for Bayazit to work correctly.");
                    else
                    {
                        if (!vertices.IsCounterClockWise())
                        {
