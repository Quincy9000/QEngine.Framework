...
using QEngine.Physics.Collision.Filtering;
using QEngine.Physics.Collision.Handlers;
...
namespace QEngine.Physics.Dynamics
{
	public class Body
	{
		...
		public Vector2 LinearVelocity
		{
			...
			set
			{
				System.Diagnostics.Debug.Assert(!float.IsNaN(value.X) && !float.IsNaN(value.Y));
		...
		public void DestroyFixture(Fixture fixture)
		{
			...
			System.Diagnostics.Debug.Assert(FixtureList.Count > 0);

			// You tried to remove a fixture that not present in the fixturelist.
			System.Diagnostics.Debug.Assert(FixtureList.Contains(fixture));
		...
		{
			System.Diagnostics.Debug.Assert(!float.IsNaN(force.X));
			System.Diagnostics.Debug.Assert(!float.IsNaN(force.Y));
			System.Diagnostics.Debug.Assert(!float.IsNaN(point.X));
			System.Diagnostics.Debug.Assert(!float.IsNaN(point.Y));
		...
		{
			System.Diagnostics.Debug.Assert(!float.IsNaN(torque));
		...
		public void ResetMassData()
		{
			...
			System.Diagnostics.Debug.Assert(BodyType == BodyType.Dynamic || BodyType == BodyType.Static);
