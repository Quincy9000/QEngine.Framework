...
namespace QEngine.Physics.Dynamics.Joints
{
    ...
    public class GearJoint : Joint
    {
        ...
        public GearJoint(Body bodyA, Body bodyB, Joint jointA, Joint jointB, float ratio = 1f)
        {
            ...
            System.Diagnostics.Debug.Assert(_typeA == JointType.Revolute || _typeA == JointType.Prismatic || _typeA == JointType.FixedRevolute || _typeA == JointType.FixedPrismatic);
            System.Diagnostics.Debug.Assert(_typeB == JointType.Revolute || _typeB == JointType.Prismatic || _typeB == JointType.FixedRevolute || _typeB == JointType.FixedPrismatic);
        ...
        public float Ratio
        {
            ...
            set
            {
                System.Diagnostics.Debug.Assert(MathUtils.IsValid(value));
                _ratio = value;
            }
        }
