...
using QEngine.Physics.Collision.Broadphase;
using QEngine.Physics.Collision.ContactSystem;
using QEngine.Physics.Collision.RayCast;
using QEngine.Physics.Collision.TOI;
using QEngine.Physics.Dynamics.Handlers;
using QEngine.Physics.Dynamics.Joints;
using QEngine.Physics.Dynamics.Solver;
using QEngine.Physics.Extensions.Controllers.ControllerBase;
using QEngine.Physics.Shared;
using QEngine.Physics.Templates;

namespace QEngine.Physics.Dynamics
{
    /// <summary>
    ...
    public class World
    {
        ...
        private void Solve(ref TimeStep step)
        {
            ...
            for (int index = BodyList.Count - 1; index >= 0; index--)
            {
                ...
                while (stackCount > 0)
                {
                    ...
                    System.Diagnostics.Debug.Assert(b.Enabled);
                    Island.Add(b);
        ...
        {
            System.Diagnostics.Debug.Assert(!_bodyAddList.Contains(body), "You are adding the same body more than once.");
        ...
        {
            System.Diagnostics.Debug.Assert(!_jointAddList.Contains(joint), "You are adding the same joint more than once.");
        ...
        private void RemoveJoint(Joint joint, bool doCheck)
        {
            if (doCheck)
            {
                System.Diagnostics.Debug.Assert(!_jointRemoveList.Contains(joint),
        ...
        {
            System.Diagnostics.Debug.Assert(!ControllerList.Contains(controller), "You are adding the same controller more than once.");
        ...
        {
            System.Diagnostics.Debug.Assert(ControllerList.Contains(controller),
        ...
        public void RemoveBreakableBody(BreakableBody breakableBody)
        {
            ...
            System.Diagnostics.Debug.Assert(BreakableBodyList.Contains(breakableBody));
