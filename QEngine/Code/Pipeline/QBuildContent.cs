...
namespace MGCB
{
    public class QBuildContent
    {
        ...
        public void Build(out int successCount, out int errorCount)
        {
            ...
            _manager.Logger = new QConsoleLogger();
            ...
            var previousContent = QSourceFileCollection.Read(contentFile);
            ...
            var newContent = new QSourceFileCollection
            {
