...
// file 'LICENSE.txt', which is part of this source code package.
		...
		namespace MGCB
		{
			...
			/// </summary>
			public class QCommandLineBuildParser
			{
				...
				public QCommandLineBuildParser(object optionsObject)
				{
						...
						else
						{
							...
							if(member is MethodInfo)
							{
								...
								if(parameters.Length == 0)
									...
									method.Invoke(_optionsObject, new[]
									{
										ChangeType(value, parameters[0].ParameterType)
									});
							}
